      ...
      <div className="pdp-shopify-outer">
        ...
        <div className="pdp-info-panel">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 16 }}>
            ...
            >
              {/* "Buy with shop" — Shop Pay button, matches Shopify's exact visual */}
              Buy with&nbsp;
              <svg xmlns="http://www.w3.org/2000/svg" width="41" height="15" fill="white" aria-label="Shop Pay" role="img" viewBox="0 0 41 15">
                <path d="M6.204 4.74c-.116-.688-.672-1.08-1.5-1.08-.796 0-1.32.355-1.32.893 0 .42.316.685.988.817l.876.168c1.34.26 2.064.913 2.064 2.005 0 1.22-1.02 2.002-2.66 2.002-1.668 0-2.74-.806-2.84-2.06h1.26c.1.69.644 1.07 1.58 1.07.888 0 1.408-.36 1.408-.913 0-.44-.308-.705-1-.845l-.888-.172C2.64 6.37 1.94 5.75 1.94 4.64c0-1.192 1.008-1.98 2.576-1.98 1.548 0 2.536.765 2.648 2.08H6.2zm5.78 1.06c0-1.196-.704-1.984-1.764-1.984-1.06 0-1.77.788-1.77 1.984s.71 1.98 1.77 1.98c1.06 0 1.764-.784 1.764-1.98zm-4.804 5.644V3.78h1.24v.812c.38-.588 1.02-.924 1.84-.924 1.54 0 2.544 1.128 2.544 2.832 0 1.7-1.004 2.832-2.544 2.832-.804 0-1.44-.328-1.82-.9v2.012H7.18zm9.524-3.644c0 .924-.58 1.432-1.596 1.432-.64 0-1.008-.284-1.008-.752 0-.42.304-.664 1.02-.752l1.584-.176v.248zm1.252 1.748V5.38c0-1.184-.84-1.88-2.268-1.88-1.38 0-2.264.716-2.312 1.836h1.196c.076-.536.472-.832 1.1-.832.672 0 1.044.32 1.044.88v.396l-1.72.188c-1.208.132-1.9.756-1.9 1.744 0 1.024.772 1.648 2.004 1.648.76 0 1.42-.32 1.732-.852.028.52.38.828.972.828.244 0 .424-.028.632-.084v-.86a.697.697 0 01-.228.032c-.184 0-.252-.1-.252-.328zm2.848-7.536h-1.26v1.568h-.96v1.024h.96V7.82c0 1.1.628 1.636 1.852 1.636.24 0 .524-.028.776-.076V8.31a2.48 2.48 0 01-.54.056c-.568 0-.828-.264-.828-.836V4.804h1.368V3.78h-1.368V2.012zm4.752 5.988c-1.08 0-1.78-.784-1.78-1.98 0-1.204.7-1.984 1.78-1.984 1.076 0 1.784.78 1.784 1.984 0 1.196-.708 1.98-1.784 1.98zm0 1.052c1.78 0 3.028-1.176 3.028-3.032S27.286 2.988 25.506 2.988 22.48 4.164 22.48 6.02s1.244 3.032 3.024 3.032zm5.356-.064V5.74c0-.788.54-1.312 1.372-1.312.8 0 1.26.5 1.26 1.38v3.18h1.26V5.516c0-1.492-.82-2.376-2.188-2.376-.832 0-1.5.348-1.88.96V3.78H31.5v5.228h-1.26l-.008-.02z"/>
              </svg>
            </a>
