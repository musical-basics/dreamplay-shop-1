          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 16 }}>
            ...
            <a
              ...
              style={{
                ...
                padding: '14px 20px',
                borderRadius: 30,           /* pill shape matching Shopify */
                fontSize: 14, fontWeight: 600,
                textDecoration: 'none', letterSpacing: '0.01em',
              }}
            >
              Buy with
              {/* Shopify Shop logo — exact SVG from Shopify's CDN */}
              <svg width="46" height="12" viewBox="0 0 46 12" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Shop" style={{ verticalAlign: 'middle' }}>
                <path fillRule="evenodd" clipRule="evenodd" d="M0 0h4.5v1.5H1.5v9H0V0Zm6 1.5h1.5V3H9V1.5h1.5V9H9V7.5H7.5V9H6V1.5Zm4.5 0H12V0h1.5v1.5H15V9h-1.5V1.5h-3Zm6 0H18V0h4.5v1.5H21V9h-1.5V1.5h-3Zm7.5 -1.5h1.5v10.5H24V0Zm4.5 0H30v1.5h1.5V0H33v1.5h1.5v7.5H33V7.5h-1.5v1.5H30V1.5h-1.5V0Zm7.5 1.5H39V0h4.5v1.5H42V9h-1.5V1.5h-3Z" fill="white"/>
              </svg>
            </a>
